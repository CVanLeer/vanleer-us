                ...
                {milestones.map((m, i) => (
                  <div key={m.title} className="flex flex-col items-center" style={{ width: "20%" }}>
                    ...
                    <div className="relative">
                      ...
                      />
                      {m.current && (
                        <div className="absolute -inset-2 animate-ping rounded-full bg-teal-500/20" />
                      )}
                    </div>
                    ...
                    <div className="mt-4 text-center">
                      ...
                      {m.current && (
                        <span className="mt-2 inline-block rounded-full bg-teal-500 px-3 py-0.5 text-xs font-medium text-white">
                          You are here
                        </span>
                      )}
                    </div>
